# pino-multi-stream &nbsp;[![Build Status](https://img.shields.io/github/workflow/status/pinojs/pino-multi-stream/CI)](https://github.com/pinojs/pino-multi-stream/actions?query=workflow%3ACI)
